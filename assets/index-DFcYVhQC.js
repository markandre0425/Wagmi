import{i as b,b as l,a as E}from"./index-BeJ45y70.js";import{n as h,r as d}from"./class-map-siut4Tqp.js";import{d as C,r as O,e as P}from"./index-DahmWcIk.js";import{c as v,U as x}from"./index-C7l3ZR2N.js";import"./index-kmZE9kHf.js";import"./index-3E48mQCx.js";import{q as g,R as S,m as $,a as R,S as T}from"./W3MFrameProviderSingleton-Dz2PlAdx.js";const L=C`
  :host {
    position: relative;
...
`;var f=function(i,t,e,n){var r=arguments.length,o=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,e):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(i,t,e,n);else for(var a=i.length-1;a>=0;a--)(s=i[a])&&(o=(r<3?s(o):r>3?s(t,e,o):s(t,e))||o);return r>3&&o&&Object.defineProperty(t,e,o),o},w;let u=w=class extends b{firstUpdated(){this.startOTPTimeout()}disconnectedCallback(){clearTimeout(this.OTPTimeout)}constructor(){super(),this.loading=!1,this.timeoutTimeLeft=g.getTimeToNextEmailLogin(),this.error="",this.otp="",this.email=S.state.data?.email,this.authConnector=$.getAuthConnector()}render(){if(!this.email)throw new Error("w3m-email-otp-widget: No email provided");const t=!!this.timeoutTimeLeft,e=this.getFooterLabels(t);return l`
      <wui-flex
