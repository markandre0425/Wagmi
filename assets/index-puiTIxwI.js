import{i as g,b as e}from"./index-BeJ45y70.js";import{r as f,n as w}from"./class-map-siut4Tqp.js";import{d as y,r as k,e as P}from"./index-donpy0xh.js";import{c as b}from"./index-Cor1_4Mh.js";import"./index-BKgjXhye.js";import{H as x}from"./HelpersUtil-BX0FycyZ.js";import{R as u,E as A}from"./W3MFrameProviderSingleton-DP4Pkyw8.js";import{o as v}from"./if-defined-DU7iu4yL.js";import"./index-Cm7CYPub.js";import"./index-Dt9H7rEw.js";const I=y`
  :host {
    display: block;
  }
...
`;var $=function(t,i,n,r){var o=arguments.length,a=o<3?i:r===null?r=Object.getOwnPropertyDescriptor(i,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,i,n,r);else for(var c=t.length-1;c>=0;c--)(s=t[c])&&(a=(o<3?s(a):o>3?s(i,n,a):s(i,n))||a);return o>3&&a&&Object.defineProperty(i,n,a),a};let p=class extends g{constructor(){super(...arguments),this.resizeObserver=void 0,this.unsubscribe=[],this.status="hide",this.view=u.state.view}firstUpdated(){this.status=x.hasFooter()?"show":"hide",this.unsubscribe.push(u.subscribeKey("view",i=>{this.view=i,this.status=x.hasFooter()?"show":"hide",this.status==="hide"&&document.documentElement.style.setProperty("--apkt-footer-height","0px")})),this.resizeObserver=new ResizeObserver(i=>{for(const n of i)if(n.target===this.getWrapper()){const r=`${n.contentRect.height}px`;document.documentElement.style.setProperty("--apkt-footer-height",r)}}),this.resizeObserver.observe(this.getWrapper())}render(){return e`
...
`;var C=function(t,i,n,r){var o=arguments.length,a=o<3?i:r===null?r=Object.getOwnPropertyDescriptor(i,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,i,n,r);else for(var c=t.length-1;c>=0;c--)(s=t[c])&&(a=(o<3?s(a):o>3?s(i,n,a):s(i,n))||a);return o>3&&a&&Object.defineProperty(i,n,a),a};const S=4;let h=class extends g{constructor(){super(...arguments),this.walletImages=[]}render(){const i=this.walletImages.length<S;return e`${this.walletImages.slice(0,S).map(({src:n,walletName:r})=>e`
          ...
          ></wui-wallet-image>
        `)}
    ${i?[...Array(S-this.walletImages.length)].map(()=>e` <wui-wallet-image size="sm" name=""></wui-wallet-image>`):null} `}};h.styles=[k,O];C([w({type:Array})],h.prototype,"walletImages",void 0);h=C([b("wui-all-wallets-image")],h);const E=y`
  :host {
    width: 100%;
  }
...
`;var m=function(t,i,n,r){var o=arguments.length,a=o<3?i:r===null?r=Object.getOwnPropertyDescriptor(i,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,i,n,r);else for(var c=t.length-1;c>=0;c--)(s=t[c])&&(a=(o<3?s(a):o>3?s(i,n,a):s(i,n))||a);return o>3&&a&&Object.defineProperty(i,n,a),a};const z={eip155:"ethereum",solana:"solana",bip122:"bitcoin",polkadot:void 0,cosmos:void 0,sui:void 0,stacks:void 0,ton:"ton"};let l=class extends g{constructor(){super(...arguments),this.walletImages=[],this.imageSrc="",this.name="",this.size="md",this.tabIdx=void 0,this.namespaces=[],this.disabled=!1,this.showAllWallets=!1,this.loading=!1,this.loadingSpinnerColor="accent-100"}render(){return this.dataset.size=this.size,e`
      <button
