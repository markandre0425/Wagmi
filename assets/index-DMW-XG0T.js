import{i as _,b as l,a as Se}from"./index-BeJ45y70.js";import{n as x,r as h,a as ye}from"./class-map-siut4Tqp.js";import{o as g}from"./if-defined-DU7iu4yL.js";import{d as U,r as be,e as Pe,v as Te}from"./index-donpy0xh.js";import{c as C,U as ve}from"./index-Cor1_4Mh.js";import"./index-DIKczTI5.js";import"./index-8g6ifAMB.js";import"./index-BNvHpBqy.js";import"./index-D1qtvdog.js";import"./index-RHeJ5ycC.js";import"./index-Dt9H7rEw.js";import"./index-CJ_2WMyO.js";import{i as I,J as ke,h as T,ad as _e,P as w,a as O,ae as Ce,$ as N,O as ie,N as A,af as ue,C as m,n as P,E as W,S as R,l as $e,M as z,c as Re,d as Oe,p as Ue,m as S,R as M}from"./W3MFrameProviderSingleton-DP4Pkyw8.js";import"./index-DSoXicRu.js";import{M as le}from"./MathUtil-BGCe3rZ3.js";const Le=U`
  :host {
    position: relative;
  }
...
`;var j=function(t,e,n,s){var a=arguments.length,i=a<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,n):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,n,s);else for(var u=t.length-1;u>=0;u--)(o=t[u])&&(i=(a<3?o(i):a>3?o(e,n,i):o(e,n))||i);return a>3&&i&&Object.defineProperty(e,n,i),i};const rt=3,ot=2,ct=.3,ut="200px",lt={"accent-primary":Te.tokens.core.backgroundAccentPrimary};let q=class extends _{constructor(){super(...arguments),this.rings=rt,this.duration=ot,this.opacity=ct,this.size=ut,this.variant="accent-primary"}render(){const e=lt[this.variant];this.style.cssText=`
    ...
    `}renderRing(e,n){const a=`animation-delay: ${e/n*this.duration}s;`;return l`<div class="pulse-ring" style=${a}></div>`}};q.styles=[be,at];j([x({type:Number})],q.prototype,"rings",void 0);j([x({type:Number})],q.prototype,"duration",void 0);j([x({type:Number})],q.prototype,"opacity",void 0);j([x()],q.prototype,"size",void 0);j([x()],q.prototype,"variant",void 0);q=j([C("wui-pulse")],q);const fe=[{id:"received",title:"Receiving funds",icon:"dollar"},{id:"processing",title:"Swapping asset",icon:"recycleHorizontal"},{id:"sending",title:"Sending asset to the recipient address",icon:"send"}],we=["success","submitted","failure","timeout","refund"],dt=U`
  :host {
    display: block;
    height: 100%;
    width: 100%;
    ...
    `}renderWalletText(){const{image:e}=this.getWalletProperties({namespace:this.namespace}),{address:n}=this.caipAddress?w.parseCaipAddress(this.caipAddress):{},s=this.selectedExchange?.name;return this.selectedExchange?l`
      ...
      <wui-flex alignItems="center" justifyContent="flex-end" gap="1">
        <wui-text variant="lg-regular" color="primary">
          ${ve.getTruncateString({string:this.profileName||n||s||"",charsStart:this.profileName?16:4,charsEnd:this.profileName?0:6,truncate:this.profileName?"end":"middle"})}
        </wui-text>
