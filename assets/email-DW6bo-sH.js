import{d as S}from"./index-donpy0xh.js";import{c as d}from"./index-Cor1_4Mh.js";import{W as C}from"./index-DHtQY_RR.js";import{C as D,h as g,O as h,E as c,M as _,R as s,S as f,a as b,m,v as $,i as W}from"./W3MFrameProviderSingleton-DP4Pkyw8.js";import{i as y,b as u,a as P}from"./index-BeJ45y70.js";import{r as E}from"./class-map-siut4Tqp.js";import"./index-Cm7CYPub.js";import"./index-CrOdLcLi.js";import{e as N,n as T}from"./ref-kDIisg3B.js";import"./index-DIKczTI5.js";import"./index-Bugzt_he.js";import"./http-suEy5Onp.js";import"./index-DtDWBCPw.js";import"./index-nibyPLVP.js";import"./index-RHeJ5ycC.js";import"./if-defined-DU7iu4yL.js";import"./index-BB5pdao8.js";var F=function(a,e,t,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var l=a.length-1;l>=0;l--)(o=a[l])&&(i=(n<3?o(i):n>3?o(e,t,i):o(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let I=class extends C{constructor(){super(...arguments),this.onOtpSubmit=async e=>{try{if(this.authConnector){const t=D.state.activeChain,r=g.getConnections(t),n=h.state.remoteFeatures?.multiWallet,i=r.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),t)await g.connectExternal(this.authConnector,t);else throw new Error("Active chain is not set on ChainController");if(h.state.remoteFeatures?.emailCapture)return;if(h.state.siwx){_.close();return}if(i&&n){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}_.close()}}catch(t){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:b.parseError(t)}}),t}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};I=F([d("w3m-email-verify-otp-view")],I);const U=S`
  wui-icon-box {
