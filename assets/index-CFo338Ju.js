import{i as m,b as h}from"./index-BeJ45y70.js";import{n as b,r as v}from"./class-map-siut4Tqp.js";import{d as k,r as g}from"./index-DahmWcIk.js";import{c as y}from"./index-C7l3ZR2N.js";import{o as C}from"./if-defined-DU7iu4yL.js";import{e as O,n as _}from"./ref-kDIisg3B.js";import{c as L,d as R,p as j,O as l}from"./W3MFrameProviderSingleton-Dz2PlAdx.js";const d=j({isLegalCheckboxChecked:!1}),f={state:d,subscribe(e){return R(d,()=>e(d))},subscribeKey(e,t){return L(d,e,t)},setIsLegalCheckboxChecked(e){d.isLegalCheckboxChecked=e}},z=k`
  label {
    display: inline-flex;
    align-items: center;
    cursor: pointer;
...
`;var x=function(e,t,s,n){var i=arguments.length,o=i<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,s):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,s,n);else for(var c=e.length-1;c>=0;c--)(r=e[c])&&(o=(i<3?r(o):i>3?r(t,s,o):r(t,s))||o);return i>3&&o&&Object.defineProperty(t,s,o),o};const E={lg:"md",md:"sm",sm:"sm"};let a=class extends m{constructor(){super(...arguments),this.inputElementRef=O(),this.checked=void 0,this.disabled=!1,this.size="md"}render(){const t=E[this.size];return h`
