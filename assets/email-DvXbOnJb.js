import{d as S}from"./index-DahmWcIk.js";import{c as d}from"./index-C7l3ZR2N.js";import{W as C}from"./index-DFcYVhQC.js";import{C as D,h as g,O as h,E as c,M as _,R as s,S as f,a as b,m,v as $,i as W}from"./W3MFrameProviderSingleton-Dz2PlAdx.js";import{i as y,b as u,a as P}from"./index-BeJ45y70.js";import{r as E}from"./class-map-siut4Tqp.js";import"./index-DIoUDobu.js";import"./index-kmZE9kHf.js";import{e as N,n as T}from"./ref-kDIisg3B.js";import"./index-hqrK4r2g.js";import"./index-D0FK73Pq.js";import"./http-suEy5Onp.js";import"./index-EBm-l0i6.js";import"./index-nibyPLVP.js";import"./index-3E48mQCx.js";import"./if-defined-DU7iu4yL.js";import"./index-n4j8EaYA.js";var F=function(a,e,t,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var l=a.length-1;l>=0;l--)(o=a[l])&&(i=(n<3?o(i):n>3?o(e,t,i):o(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let I=class extends C{constructor(){super(...arguments),this.onOtpSubmit=async e=>{try{if(this.authConnector){const t=D.state.activeChain,r=g.getConnections(t),n=h.state.remoteFeatures?.multiWallet,i=r.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),t)await g.connectExternal(this.authConnector,t);else throw new Error("Active chain is not set on ChainController");if(h.state.remoteFeatures?.emailCapture)return;if(h.state.siwx){_.close();return}if(i&&n){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}_.close()}}catch(t){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:b.parseError(t)}}),t}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};I=F([d("w3m-email-verify-otp-view")],I);const U=S`
  wui-icon-box {
