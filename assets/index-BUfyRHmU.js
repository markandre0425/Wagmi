import{i as h,b as d}from"./index-BeJ45y70.js";import{n as i}from"./class-map-siut4Tqp.js";import{o as c}from"./if-defined-DU7iu4yL.js";import"./index-3E48mQCx.js";import{c as m}from"./index-C7l3ZR2N.js";import{d as g,r as y,e as f}from"./index-DahmWcIk.js";const b=g`
  :host {
    width: 100%;
  }
...
`;var t=function(e,n,a,l){var s=arguments.length,r=s<3?n:l===null?l=Object.getOwnPropertyDescriptor(n,a):l,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(e,n,a,l);else for(var p=e.length-1;p>=0;p--)(u=e[p])&&(r=(s<3?u(r):s>3?u(n,a,r):u(n,a))||r);return s>3&&r&&Object.defineProperty(n,a,r),r};let o=class extends h{constructor(){super(...arguments),this.type="primary",this.imageSrc="google",this.imageSize=void 0,this.loading=!1,this.boxColor="foregroundPrimary",this.disabled=!1,this.rightIcon=!0,this.boxed=!0,this.rounded=!1,this.fullSize=!1}render(){return this.dataset.rounded=this.rounded?"true":"false",this.dataset.type=this.type,d`
    ...
    `}templateLeftIcon(){return this.icon?d`<wui-image
      ...
      src=${this.imageSrc}
      boxColor=${this.boxColor}
    ></wui-image>`}templateRightIcon(){return this.rightIcon?this.loading?d`<wui-loading-spinner size="md" color="accent-primary"></wui-loading-spinner>`:d`<wui-icon name="chevronRight" size="lg" color="default"></wui-icon>`:null}};o.styles=[y,f,b];t([i()],o.prototype,"type",void 0);t([i()],o.prototype,"imageSrc",void 0);t([i()],o.prototype,"imageSize",void 0);t([i()],o.prototype,"icon",void 0);t([i()],o.prototype,"iconColor",void 0);t([i({type:Boolean})],o.prototype,"loading",void 0);t([i()],o.prototype,"tabIdx",void 0);t([i()],o.prototype,"boxColor",void 0);t([i({type:Boolean})],o.prototype,"disabled",void 0);t([i({type:Boolean})],o.prototype,"rightIcon",void 0);t([i({type:Boolean})],o.prototype,"boxed",void 0);t([i({type:Boolean})],o.prototype,"rounded",void 0);t([i({type:Boolean})],o.prototype,"fullSize",void 0);o=t([m("wui-list-item")],o);
