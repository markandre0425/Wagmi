import{i as L,b as c}from"./index-BeJ45y70.js";import{n as k,r as l}from"./class-map-siut4Tqp.js";import{o as $}from"./if-defined-DU7iu4yL.js";import{d as O}from"./index-donpy0xh.js";import{c as _}from"./index-Cor1_4Mh.js";import{O as R}from"./index-B3iJz7T2.js";import{e as W}from"./index-B3oXCX2q.js";import{m as E,O as h,x as T,R as f,b as F,a as v,y as D,A as N,C as d,h as S,E as u,o as A,S as C,z as M,M as I,T as x}from"./W3MFrameProviderSingleton-DP4Pkyw8.js";import"./index-Cm7CYPub.js";import{C as j}from"./ConstantsUtil-COJBkkkj.js";import"./index-DIKczTI5.js";import"./index-hikc7brX.js";import"./index-DSoXicRu.js";import"./http-suEy5Onp.js";import"./index-DtDWBCPw.js";import"./index-nibyPLVP.js";import"./ref-kDIisg3B.js";import"./index-RHeJ5ycC.js";import"./index-BNvHpBqy.js";import"./browser-Du_7q3n2.js";const z=O`
  :host {
...
`;var g=function(t,e,i,r){var s=arguments.length,o=s<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,i,o):n(e,i))||o);return s>3&&o&&Object.defineProperty(e,i,o),o};let p=class extends L{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=E.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=h.state.remoteFeatures,this.isPwaLoading=!1,this.hasExceededUsageLimit=T.state.plan.hasExceededUsageLimit,this.unsubscribe.push(E.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(i=>i.type==="AUTH")}),h.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=this.remoteFeatures?.socials||[];const i=!!this.authConnector,r=e?.length,s=f.state.view==="ConnectSocials";return(!i||!r)&&!s?null:(s&&!r&&(e=F.DEFAULT_SOCIALS),c` <wui-flex flexDirection="column" gap="2">
...
`;var U=function(t,e,i,r){var s=arguments.length,o=s<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,i,o):n(e,i))||o);return s>3&&o&&Object.defineProperty(e,i,o),o};let P=class extends L{constructor(){super(),this.unsubscribe=[],this.checked=R.state.isLegalCheckboxChecked,this.unsubscribe.push(R.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{termsConditionsUrl:e,privacyPolicyUrl:i}=h.state,r=h.state.features?.legalCheckbox,n=!!(e||i)&&!!r&&!this.checked,a=n?-1:void 0;return c`
    ...
    `}};P.styles=q;U([l()],P.prototype,"checked",void 0);P=U([_("w3m-connect-socials-view")],P);const B=O`
  wui-logo {
    width: 80px;
    height: 80px;
